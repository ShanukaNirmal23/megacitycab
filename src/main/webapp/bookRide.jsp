            ...
            <div class="col-md-6">
                <div class="card shadow-lg">
                    <div class="card-body">
                        ...
                        <form id="rideForm" action="BookRideServlet" method="post">
                            <!-- Pickup Location -->
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="rideType" name="rideType" class="form-select">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="fare" name="fare" class="form-control" disabled>
                            </div>
                            <!-- Buttons -->
